export enum AboutUsPageText {
  ...
  Marat = 'Marat Bondarenko - hard worker and a team leader. Contributed to the common cause - 7260/9895 lines code.',
  Alex = 'Aliaksandr Klintsevich - ex-team leader. Contributed to the common cause - 859/9895 lines code.',
  Mikalai = 'Mikalai Aliakhnovich - Contributed to the common cause - 1776/9895 lines code.',
